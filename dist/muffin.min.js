	  ...
	  _composeAncesstry() {
	    ...
	    if (this.attributes.parent) {
	      ...
	      if (this.attributes.childscope) {
	        ...
	        this.getParent().interface.dispatchMessage("child-composed", {
	          key: childscopeKey,
	          instance: this
	        });
	      }
